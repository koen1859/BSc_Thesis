...
\begin{enumerate}
	\item An analysis of the BHH formula under more realistic conditions, specifically:
	      \begin{enumerate}
	      ...
	      \end{enumerate}
	\item A machine learning analysis to investigate which spatial features (e.g., address density, road network characteristics)
	      influence deviations from the BHH formula's predictions.
\end{enumerate}
