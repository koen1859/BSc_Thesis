...
Additionally, a number of features is extracted, to be able to perform the machine learning analysis.
In total, for each area information about 80 features is gathered.
