...
The average path length between all nodes in the graph of the road network and $n$ (the number of locations in the) TSP are by far the most important features.
