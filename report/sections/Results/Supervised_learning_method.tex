...
An $R^2$ of 0.96 is found on the train data for both the full
...
reduced model is slightly lower compared to the full model, on the test data. This implies the full model is slightly over-fitting on the training data.
