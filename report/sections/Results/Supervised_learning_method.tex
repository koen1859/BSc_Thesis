...
A summary of the results of the Random Forest model is listed in Table \ref{tab:ml_results_small}.
...
Figure \ref{tab:feature-importance} displays the most important features for predicting TSP path length, according to the Random Forest model.
\begin{figure}[H]
	\centering
