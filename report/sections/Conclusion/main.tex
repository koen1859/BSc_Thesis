...
In such cases, predictions from the BHH formula are unreliable.
Estimating the true value of $\beta$ defeats the purpose of the BHH formula since this requires simulations.
...
When considering a low number of stops and a realistic road network,
we advise entities that aim to estimate TSP path lengths to use the Lin-Kernighan heuristic instead of BHH formula, as it improves prediction accuracy and requires little computing power.
