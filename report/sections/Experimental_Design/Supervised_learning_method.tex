...
\begin{enumerate}
	...
	\item Re-run the model with a reduced feature set, only using the most important features. This requires some testing, to analyze what the treshold
	      for dropping out features should be.
\end{enumerate}
