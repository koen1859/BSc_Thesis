...
be extracted from there. For this analysis, natural features (i.e. water), leisure features (i.e. parks) and road network features (i.e. percentage of roads oneway) 
are used.
